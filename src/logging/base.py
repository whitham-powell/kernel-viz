...
#         values = self.metrics.get(name, [])  # FIMXE: should this be a copy instead?
...
#         self.state_manager = StateManger[T]()
...
#         value: Any,
#     ) -> None:
#         """Log algorithm paramter changes."""
